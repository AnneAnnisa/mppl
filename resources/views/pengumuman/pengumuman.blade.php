            ...
            <div class="container">
              ...
              <div class="row">
                ...
                <div class="col-md-8">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form action="{{url('lihatpengumuman/cek')}}" method="post" role="form">
                        <div class="box-body">
                           {{ csrf_field() }}
                            <div class="form-group">
                                <label for="exampleInputEmail1">NIM / Nomor Induk Mahasiswa</label>
                                <input name="nim" type="text" class="form-control" id="exampleInputEmail1" placeholder="5114100024" required="">
                            </div>
                ...
                <div class="box-footer">
                  <button type="submit" class="btn btn-primary pull-right">Lihat Pengumuman</button>
              </div>
          </form>
      </div>
      <!-- /.box -->
